...
<style>
    ...
    .dresscode-item img {
        ...
        pointer-events: none;
        /* Important : le clic se passe au niveau du <a>, pas de <img> */
    }
                    ...
                    <div class="col-lg-8 align-self-center">
                        <div class="wedding-invitation white-bg p-5">
                            ...
                            <div class="wedding-card-body position-relative mb-50">
                                ...
                                <h1 class="my-2 mt-30">{{ $invitation->guests->type . ' ' . $invitation->guests->nom }}
                                </h1>
                                ...
                                @switch($invitation->status)
                                    @case('send')
                                        <button type="button" class="btn rsvp-btn mt-10 rounded-pill" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal" style="border-radius: 50px !important">Confirmez
                                            votre présence</button>
                                    @break
